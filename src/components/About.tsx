  ...
  return (
    <Wrapper>
      ...
      <Body>
        ...
        <Link href="https://docs.google.com/document/d/1QVQ4G0-sS4zg6MwczQsNDKArAYDwH4Vu/edit?usp=sharing&ouid=106646816568438649150&rtpof=true&sd=true">Resume.</Link>
        <br />
        <br />
        <Hobbies />
